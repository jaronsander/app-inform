...
export default function Home() {
  return (
    ...
    <p className="text-md leading-relaxed">
      <span className="font-semibold">Form Configuration Panel:</span> The panel on the right allows you to modify the form purpose and the company description that is the input to the form. In a real use case, this would be behind a login and hidden from the end user.
    </p>
    <p className="text-md leading-relaxed">
      <span className="font-semibold">Dynamic Form Interaction:</span> The form on the right will dynamically generate a question per stage and possible answers to that question. Once a certain amount of questions have been answered, a summary of the form submission is generated. Since this is a demo, the generation of questions is fairly slow and is something that will be optimised in the future.
    </p>
  </div>
