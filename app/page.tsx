...
export default function Home() {
  return (
    <div className="bg-black text-white py-20">
      ...
      <p className="text-gray-300 mb-10">Currently prompted to be a sales assistant for a "Data Agency". A link to book a meeting appears if the lead is not unqualified.</p>
      </div>
